...
- [FlashVSR](https://github.com/OpenImagingLab/FlashVSR), a real-time one-step diffusion-based streaming video super-resolution framework based on **Wan2.1-T2V-1.3B** for high-resolution, high-quality video super-resolution. Refer to the [project page](https://zhuang2002.github.io/FlashVSR) for more examples.
