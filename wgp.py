...
def generate_queue_html(queue):
    ...
    <table>
        <thead>
            <tr>
                <th style="width:4%;" class="center-align" title="Drag to reorder"></th>
    ...
    for i, item in enumerate(queue):
        ...
        drag_handle = f"""<td draggable="true" class="drag-handle center-align" title="Drag to reorder"><svg viewBox="0 0 64 64">
